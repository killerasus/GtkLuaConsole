...
LDLIBSOPTIONS=`pkg-config --libs gtk+-2.0` `pkg-config --libs lua5.1`
...
${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_DEBUG `pkg-config --cflags gtk+-2.0` `pkg-config --cflags lua5.1`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
