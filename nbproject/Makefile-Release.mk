...
LDLIBSOPTIONS=`pkg-config --libs lua5.1` `pkg-config --libs gtk+-2.0`
...
${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `pkg-config --cflags lua5.1` `pkg-config --cflags gtk+-2.0`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
